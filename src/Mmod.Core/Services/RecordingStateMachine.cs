...
public static class RecordingStateMachine
{
    ...
    private static readonly Dictionary<NodeExecutionStage, NodeExecutionStage[]> Legal = new()
    {
        ...
        [NodeExecutionStage.FinalizingEncoder] = [NodeExecutionStage.ValidatingClip, NodeExecutionStage.ControlledStopFinalized],
        [NodeExecutionStage.ControlledStopFinalized] = [NodeExecutionStage.Failed, NodeExecutionStage.Canceled],
